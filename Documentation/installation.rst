...
#. Add a dependency ``brotkrueml/typo3-jobrouter-base`` to your project's
...
#. Get the extension
   ...
   #. **Get it from the Extension Manager:** Select the
      ...
      extension key ``jobrouter_base`` and import the extension from the
      repository.

   #. **Get it from typo3.org:** You can always get the current version from
      `https://extensions.typo3.org/extension/jobrouter_base/
      <https://extensions.typo3.org/extension/jobrouter_base/>`_ by
