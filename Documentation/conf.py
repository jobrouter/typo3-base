...
htmlhelp_basename = 'TYPO3JobRouterBasedoc'
...
latex_documents = [
    (master_doc, 'TYPO3JobRouterBase.tex', u'TYPO3 JobRouter Base Documentation',
...
man_pages = [
    (master_doc, 'typo3jobrouterbase', u'TYPO3 JobRouter Base Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TYPO3JobRouterBase', u'TYPO3 JobRouter Base Documentation',
     author, 'TYPO3JobRouterBase', 'One line description of project.',
     'Miscellaneous'),
]
